                            ...
                            <td>
                                  ...
                                  <td>
                                      <div class="form-group <?php if(form_error('fac_fecha_emision')!=''){ echo 'has-error';}?> ">
                                        <input type="date" class="form-control" name="fac_fecha_emision" id="fac_fecha_emision" value="<?php if(validation_errors()!=''){ echo set_value('fac_fecha_emision');}else{ echo $factura->fac_fecha_emision;}?>" <?php echo $factura->etq ?> >
